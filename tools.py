...
def _buscar_supermercado_via_serpapi(producto: str, tienda: str, dominio: str) -> dict:
    ...
    try:
        ...
        aliases = {
            ...
            "farmaciasahumada.cl": ["ahumada", "farmacias ahumada", "farmacia"],
            "salcobrand.cl":      ["salcobrand", "farmacia"],
            "drogueriasimi.cl":   ["simi", "dr simi", "dr. simi", "farmacia"],
            "cruzverde.cl":       ["cruz verde", "cruzverde", "farmacia"],
